...
<div class="section">
  <div class="text-subsection">
    ...
    <p>Receipts was conceived as a lightweight utility app, the purpose of which is to help people store, view, and organize their digital receipts. The app <strong>does not</strong> track expenses, calculate budgets, or provide business reviews, all things that other app services can do better.</p>
